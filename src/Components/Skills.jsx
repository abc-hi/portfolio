    ...
    return (
      <div className="page-container" style={{ backgroundColor: 'var(--bs-dark)'}}>
        <h5 className="skills-title" style={{color:"white",textAlign:"center"}}>Skills</h5> {/* Use class for styling */}
            ...
            <div className="card mx-auto" data-bs-theme="dark" style={{width: "42rem", height:"95vh"}}>
...
<div className="card mx-auto" data-bs-theme="dark" style={{width: "40rem", height:"55vh"}}>
  <div className="card-body">
