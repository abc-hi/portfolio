...
const Education = () => {
    ...
    return (
        <div>
            ...
            <h5 className="skills-title" style={{color:"white",textAlign:"center",fontSize: "24px"}}>Education</h5> {/* Use class for styling */}
            <br />

            <div className="container" data-bs-theme="dark">
            <div className='color' data-bs-theme="dark">
            <div className="card border-light mb-3 mx-auto" style={{maxWidth: "48rem"}}>
  <h5 className="card-header mb-3 mx-auto" style={{fontSize:"20px"}}>Selvam College of Technology</h5>
  <h5 className="card-title mb-3 mx-auto" style={{fontSize:"20px"}}>Bachelor of Engineering - B.E, - Computer Science and Engineering</h5>
  <p className="card-title mb-3 mx-auto" style={{fontSize:"20px"}}>2006 - 2010</p>
...
<div className="card border-light mb-3 mx-auto" style={{maxWidth: "48rem"}}>
  <h5 className="card-header mx-auto" style={{fontSize:"20px"}}>Shri AAnjaneya Higher Secondary School</h5>
  <h5 className="card-title mx-auto" style={{fontSize:"20px"}}>HSC</h5>
  <p className="card-title mb-3 mx-auto" style={{fontSize:"20px"}}>2005 - 2006</p>
...
<div className="card border-light mb-3 mx-auto" style={{maxWidth: "48rem"}}>
  <h5 className="card-header mx-auto" style={{fontSize:"20px"}}>Municipal High School</h5>
  <h5 className="card-title mx-auto" style={{fontSize:"20px"}}>SSLC</h5>
  <p className="card-title mb-3 mx-auto" style={{fontSize:"20px"}}>2003 - 2004</p>
