...
const Projects = () => {
    ...
    return (
        ...
        <div className="page-container" style={{ backgroundColor: 'var(--bs-dark)', padding: "20px"}}>
            ...
            <span >
           <div style={{ fontSize: "24px" }}> <h5 className="skills-title" style={{color:"white",textAlign:"center"}}>Projects</h5></div> {/* Use class for styling */} <br />
...
<div className="card-body">
    <div style={{ fontSize: "24px" }}> <h5 className="card-title">ItemCatelog</h5></div>
...
<div className="card" style={{width: "18rem", backgroundColor: "var(--bs-dark)", color: "#fff"}}>
  ...
  <div className="card-body">
    <div style={{ fontSize: "24px" }}> <h5 className="card-title">Job Portal</h5></div>
    <div style={{ fontSize: "20px" }}><p className="card-text">It is a ecommerce full stack project and created with MERN stack.</p>
  ...
  <div className="card-body">
    <div style={{ fontSize: "24px" }}> <h5 className="card-title">WeatherApp</h5></div>
  ...
  <div className="card-body">
    <div style={{ fontSize: "24px" }}> <h5 className="card-title">RAG Based career Assistant Chatbot</h5></div>
